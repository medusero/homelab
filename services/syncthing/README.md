...
## Puertos
Mientras que el resto de aplicaciones de este repositorio no expone puertos al confiar su acceso externo a Tailscale, Syncthing es una de las excepciones; expone el puerto 22000 necesario para su correcto funcionamiento como nodo de sincronización. El acceso a la UI sigue el patrón habitual, vía Tailscale.
